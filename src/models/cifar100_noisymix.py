'''
NoixyMix Wide ResNet architecture for CIFAR-100. From

N. B. Erichson, et. al. NoisyMix: Boosting Model Robustness to Common Corruptions. AISTATS, 2024.

Code source: https://github.com/erichson/NoisyMix/blob/main/src/cifar_models/wide_resnet.py
'''
...
from noisymix_mixup import do_noisy_mixup
